// This script was originally generated by emscripten,
// I've modified it slightly to work for my own html.
// Most of it is the posix layer, I don't think it's 
// realistic for me to write it myself
...
var emscriptenWebGLGetTexPixelData = (type, format, width, height, pixels, _internalFormat) => {
...
var _glShaderBinary = (_count, _shaders, _binaryformat, _binary, _length) => {
  GL.recordError(1280)
};
...
var _emscripten_set_canvas_element_size = (target, width, height) => {
  console.log("_emscripten_set_canvas_element_size: ", canvas);
...
var registerMouseEventCallback = (target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, _targetThread) => {
...
var registerFullscreenChangeEventCallback = (target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, _targetThread) => {
...
var registerGamepadEventCallback = (target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, _targetThread) => {
...
var Browser = {
  ...
  init() {
    ...
    audioPlugin["handle"] = function audioPlugin_handle(byteArray, name, onload, _onerror) {
      var done = false;
      ...
      audio.onerror = function audio_onerror(_event) {
        if (done) return;
  ...
  destroyContext(_canvas, _useWebGL, _setInModule) { },
...
var registerUiEventCallback = (target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, _targetThread) => {
...
var registerTouchEventCallback = (target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, _targetThread) => {
...
var _glfwGetVideoModes = (_monitor, count) => {
  HEAP32[count >> 2] = 0;
  return 0
};
var _glfwInit = () => {
...
var _glfwMakeContextCurrent = _winid => { };
...
var _main = Module["_main"] = (a0, a1) => (_main = Module["_main"] = wasmExports["ie"])(a0, a1);
...
var stackSave = () => (stackSave = wasmExports["le"])();
var stackRestore = a0 => (stackRestore = wasmExports["me"])(a0);
var stackAlloc = a0 => (stackAlloc = wasmExports["ne"])(a0);
var ___cxa_is_pointer_type = a0 => (___cxa_is_pointer_type = wasmExports["oe"])(a0);
...
function run() {
  function doRun() {
    if (calledRun) return;
    // Hand modified because it wasn't working
    Module = window.Module;
    out = Module["print"] || console.log.bind(console);
    err = Module["printErr"] || console.log.bind(console);
    // 
    calledRun = true;
